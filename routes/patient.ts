...
/* async function CreatePermission(id: string, P_ID: string, R_ID: string, D_ID: string, Timestamp: string, StatusOfRequest:string, Organization: string, RequestedTime: string) {
